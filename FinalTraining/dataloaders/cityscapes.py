...
class Cityscapes(data.Dataset):
    ...
    # Test dataset root folders, citysacpe does not test set availabel so we use the val data
    test_folder = "leftImg8bit/val"
    test_lbl_folder = "gtFine/val"
    
    
    # if it is final trainning on the dataset from the active learning uncomment line 32 and 33
    # train_folder = 'AL_Iter_RGB_fcn_equal_1_12'
    # train_lbl_folder = 'AL_Iter_Ann_fcn_equal_1_12'
